...
- `0001-adapt-v0.5-inference-to-npu.patch`
  ...
  - 修改原项目已有 `inference.py`、`generation_utils.py`、`XY_Tokenizer/inference.py`、`XY_Tokenizer/utils/helpers.py`、`XY_Tokenizer/xy_tokenizer/model.py`、`XY_Tokenizer/xy_tokenizer/nn/quantizer.py`。
